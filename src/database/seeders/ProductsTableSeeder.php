...
class ProductsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $param = [
            'name' => 'キウイ',
            'price' => 800,
            'image' => '/src/resources/views/img/kiwi.png',
        ...
        $param = [
            'name' => 'ストロベリー',
            'price' => 1200,
            'image' => '/src/resources/views/img/strawberry.png',
        ...
        $param = [
            'name' => 'オレンジ',
            'price' => 850,
            'image' => '/src/resources/views/img/orange.png',
        ...
        $param = [
            'name' => 'スイカ',
            'price' => 700,
            'image' => '/src/resources/views/img/watermelon.png',
        ...
        $param = [
            'name' => 'ピーチ',
            'price' => 1000,
            'image' => '/src/resources/views/img/peach.png',
        ...
        $param = [
            'name' => 'シャインマスカット',
            'price' => 1400,
            'image' => '/src/resources/views/img/muscat.png',
        ...
        $param = [
            'name' => 'パイナップル',
            'price' => 800,
            'image' => '/src/resources/views/img/pineapple.png',
        ...
        $param = [
            'name' => 'ブドウ',
            'price' => 1100,
            'image' => '/src/resources/views/img/grapes.png',
        ...
        $param = [
            'name' => 'バナナ',
            'price' => 600,
            'image' => '/src/resources/views/img/banana.png',
        ...
        $param = [
            'name' => 'メロン',
            'price' => 900,
            'image' => '/src/resources/views/img/melon.png',
